...
# works but joints are put into bad positions 
...
def main():
    ...
    for i in range(len(boxes)):
        ...
        if first == False:
            for p in range(13, len(placeTrajectory)):
